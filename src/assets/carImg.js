// export function carImage(name, color, id) {
//     return `
//     <button class="select-btn" data-id="${id}">Select</button>
//     <button class="remove-btn" data-id="${id}">Remove</button><br>
//     <button data-id="${id}">Start race</button>
//     <button data-id="${id}">End race</button>
//     <p>${name}</p>
//     <div class="car__racer">
//     <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="110" height="110" viewBox="0 0 256 256" xml:space="preserve">
